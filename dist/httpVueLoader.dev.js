...
(function umd(root, factory) {
  if ((typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object' && (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else root.httpVueLoader = factory();
})(void 0, function factory() {
  'use strict';

  var scopeIndex = 0;
  StyleContext.prototype = {
    withBase: function withBase(callback) {
      var tmpBaseElt;
    ...
    scopeStyles: function scopeStyles(styleElt, scopeName) {
      function process() {
    ...
    compile: function compile() {
      ...
      if (scoped) {
        ...
        if (!hasTemplate) return; // firefox does not tolerate this attribute
  ...
  ScriptContext.prototype = {
    ...
    compile: function compile(module) {
      ...
      return Promise.resolve(this.module.exports).then(httpVueLoader.scriptExportsHandler.bind(this)).then(function (exports) {
  ...
  TemplateContext.prototype = {
    ...
    getRootElt: function getRootElt() {
  ...
  Component.prototype = {
    ...
    load: function load(componentURL) {
      return httpVueLoader.httpRequest(componentURL).then(function (responseText) {
        this.baseURI = componentURL.substr(0, componentURL.lastIndexOf('/') + 1);
        var doc = document.implementation.createHTMLDocument(''); // IE requires the <base> to come with <style>
    ...
    _normalizeSection: function _normalizeSection(eltCx) {
      var p;
  ...
  httpVueLoader.load = function (url, name) {
    return function () {
      return new Component(name).load(url).then(function (component) {
